...
public interface ISpecialArmor
{
     ...
     */
    ArmorProperties getProperties(LivingEntity player, @Nonnull ItemStack armor, DamageSource source, float damage, int slot);
     ...
     * @param slot The armor slot the item is in.
     */
    void damageArmor(LivingEntity entity, @Nonnull ItemStack stack, DamageSource source, int damage, int slot);
    ...
    public static class ArmorProperties implements Comparable<ArmorProperties>
    {
         ...
         */
        public static float applyArmor(LivingEntity entity, NonNullList<ItemStack> inventory, DamageSource source, float damage)
        {
            if (DEBUG)
            {
            ...
            if (damage > 0 && (totalArmor > 0 || totalToughness > 0))
            {
                ...
                for (int i = 0; i < inventory.size(); i++)
                {
                    ...
                    {
                        inventory.get(i).setDamageValue((int)armorDamage);
