package com.maciej916.indreb.common.item.impl.quantum;
...
public class ItemQuantumArmour extends ElectricArmorItem implements IJetpack {

    protected static final Map<MobEffect, Integer> potionRemovalCost = new IdentityHashMap<>();

    public ItemQuantumArmour(EquipmentSlot pSlot) {
        super(ModArmorMaterials.QUANTUM, pSlot, new Properties(), 0, 10000000, EnergyType.RECEIVE, EnergyTier.SUPER);
